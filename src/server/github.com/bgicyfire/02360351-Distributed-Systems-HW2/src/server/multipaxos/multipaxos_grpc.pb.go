...
const (
	...
	MultiPaxosService_GetPaxosInstance_FullMethodName = "/scooter.MultiPaxosService/GetPaxosInstance"
	MultiPaxosService_GetLastGoodSlot_FullMethodName  = "/scooter.MultiPaxosService/GetLastGoodSlot"
	MultiPaxosService_GetSnapshot_FullMethodName      = "/scooter.MultiPaxosService/GetSnapshot"
)
...
type MultiPaxosServiceClient interface {
	...
	GetPaxosInstance(ctx context.Context, in *GetPaxosInstanceRequest, opts ...grpc.CallOption) (*GetPaxosInstanceResponse, error)
...
func (c *multiPaxosServiceClient) GetPaxosInstance(ctx context.Context, in *GetPaxosInstanceRequest, opts ...grpc.CallOption) (*GetPaxosInstanceResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetPaxosInstanceResponse)
	err := c.cc.Invoke(ctx, MultiPaxosService_GetPaxosInstance_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *multiPaxosServiceClient) GetSnapshot(ctx context.Context, in *GetSnapshotRequest, opts ...grpc.CallOption) (*GetSnapshotResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetSnapshotResponse)
	err := c.cc.Invoke(ctx, MultiPaxosService_GetSnapshot_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MultiPaxosServiceServer interface {
	...
	GetPaxosInstance(context.Context, *GetPaxosInstanceRequest) (*GetPaxosInstanceResponse, error)
...
func (UnimplementedMultiPaxosServiceServer) GetPaxosInstance(context.Context, *GetPaxosInstanceRequest) (*GetPaxosInstanceResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPaxosInstance not implemented")
}
...
func (UnimplementedMultiPaxosServiceServer) GetSnapshot(context.Context, *GetSnapshotRequest) (*GetSnapshotResponse, error) {
...
func _MultiPaxosService_GetPaxosInstance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetPaxosInstanceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MultiPaxosServiceServer).GetPaxosInstance(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MultiPaxosService_GetPaxosInstance_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MultiPaxosServiceServer).GetPaxosInstance(ctx, req.(*GetPaxosInstanceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _MultiPaxosService_GetSnapshot_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetSnapshotRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MultiPaxosServiceServer).GetSnapshot(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MultiPaxosService_GetSnapshot_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MultiPaxosServiceServer).GetSnapshot(ctx, req.(*GetSnapshotRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MultiPaxosService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetPaxosInstance",
			Handler:    _MultiPaxosService_GetPaxosInstance_Handler,
		},
		{
		...
		},
		{
			...
			Handler:    _MultiPaxosService_GetSnapshot_Handler,
		},
	},
